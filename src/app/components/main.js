    ...
    return ( 
      ...
      <div className='flex flex-col justify-center align-center bg-[#FFC244FF]  px-4 pt-[108px] pb-[24px]'>
        <div className='flex items-center justify-center'>
           <video data-test-id="animation-video" autoPlay="autoplay" loop="loop" muted="muted"  width="281" height="252" className="w-full max-w-[452px]" data-v-f4daae2a=""><source src="https://res.cloudinary.com/glovoapp/video/upload/website_assets/images/landing/address-container-animation.webm" preload="auto" type="video/mp4" data-v-f4daae2a="" playsInline/></video>
        </div>
