...
const Main = () => {
  ...
  useEffect(()=>{
    ...
    return ( 
        <div>
             <div className={`flex justify-between bg-[#FFC244FF] pt-[9px] md:pt-[20px] pb-[13px] px-4 md:px-16 fixed z-50 top-0 w-full ${pageScrolled && !addressState && "shadow-md"}`}>
            <img src="/images/logo.svg" alt="" className='max-w-[78px]'/>
            <button className='text-[14px] font-bold rounded-full text-white bg-[#00A082FF]  min-w-[128px] md:min-w-[138px] h-[38px] md:h-[44px] outline-none max-w-[548px] cursor-pointer' onClick={openAuthModal}>Get Started</button>
          </div>
          <div className={`flex flex-col items-center justify-center bg-[#FFC244FF]  pb-[13px] px-4 fixed -top-16 md:-top-11 z-40 w-full transition duration-500  ${addressState && "translate-y-[120px]"}`}>
          ...
          <div className='flex max-md:flex-col justify-center align-center bg-[#FFC244FF]  px-4 pt-[108px] pb-[24px] jumbotron'>
            ...
            <div className='flex flex-col items-center justify-center'>
              <h3 className='text-[36px] md:text-[58px] md:max-w-[606px] md:leading-[50px] font-bold text-center leading-[40px] py-[16px]'>Food delievery and more</h3>
              <p className='text-[16px] md:text-[20px] font-normal mb-[8px]'>Groceries, shops, pharmacies, anything!</p>
          ...
          <div className="flex flex-col items-center justify-center w-full px-4 md:px-16 py-[48px]  address-open max-md:top-restaurants">
            <h2 className="py-[32px] text-[32px] md:text-[40px] font-extrabold text-center leading-[1.2] "><span className="">Top restaurants and more </span>in Glovo</h2>
          <div className="scroll flex w-full max-w-[1500px] overflow-y-auto overflow-x-auto box-border sm:grid sm:grid-cols-4 md:max-w-[750px]">
            <div className="flex flex-col items-center justify-center" onClick={openMapModal}>
              ...
              <span className="w-36 flex items-center justify-center">
                <h2 className="font-bold text-[16px] p-[4px] bg-[#FFC244FF] rounded-lg flex justify-center items-center -translate-y-5 px-2">McDonald's</h2>
              </span>
            </div>
            <div className="flex flex-col items-center justify-center" onClick={openMapModal}>
              <img src="/images/kfc.webp" alt="" className="w-32 rest-img"/>
              <span className="w-36 flex items-center justify-center">
                <h2 className="font-bold text-[16px] p-[4px] px-2 bg-[#FFC244FF] rounded-lg flex justify-center items-center -translate-y-5">KFC</h2>
              </span>
            </div>
            <div className="flex flex-col items-center justify-center" onClick={openMapModal}>
              <img src="/images/bgk.webp" alt="" className="w-32 rest-img"/>
              <span className="w-36 flex items-center justify-center">
                <h2 className="font-bold text-[16px] p-[4px] bg-[#FFC244FF] rounded-lg flex justify-center items-center -translate-y-5 px-2">BurgerKing</h2>
              </span>
            </div>
            <div className="flex flex-col items-center justify-center " onClick={openMapModal}>
              <img src="/images/cfr.webp" alt="" className="w-32 rest-img"/>
              <span className="w-36 flex items-center justify-center">
                <h2 className="font-bold text-[16px] p-[4px] bg-[#FFC244FF] rounded-lg flex justify-center items-center -translate-y-5 px-2">Carrefour</h2>
              </span>
            </div>
            <div className="flex flex-col items-center justify-center" onClick={openMapModal}>
              <img src="/images/pizzahut.webp" alt="" className="w-32 rest-img"/>
              <span className="w-36 flex items-center justify-center">
                <h2 className="font-bold text-[16px] p-[4px] bg-[#FFC244FF] rounded-lg flex justify-center items-center -translate-y-5 px-2">PizzaHut</h2>
              </span>
            </div>
            <div className="flex flex-col items-center justify-center" onClick={openMapModal}>
              <img src="/images/pjn.webp" alt="" className="w-32 rest-img"/>
              <span className="w-36 flex items-center justify-center">
                <h2 className="font-bold text-[16px] p-[4px] bg-[#FFC244FF] rounded-lg flex justify-center items-center -translate-y-5 px-2">PapaJohn's</h2>
              </span>
            </div>
            <div className="flex flex-col items-center justify-center" onClick={openMapModal}>
              <img src="/images/sby.webp" alt="" className="w-32 rest-img"/>
              <span className="w-36 flex items-center justify-center">
                <h2 className="font-bold text-[16px] p-[4px] bg-[#FFC244FF] rounded-lg flex justify-center items-center -translate-y-5 px-2">Subway</h2>
              </span>
            </div>
            <div className="flex flex-col items-center justify-center" onClick={openMapModal}>
              <img src="/images/tcb.webp" alt="" className="w-32 rest-img"/>
              <span className="w-36 flex items-center justify-center">
                <h2 className="font-bold text-[16px] p-[4px] bg-[#FFC244FF] rounded-lg flex justify-center items-center -translate-y-5 px-2">TacoBell</h2>
              </span>
            </div>
          </div>
          </div>
        
          <div className="flex flex-col items-center max-md:justify-center px-4 md:px-16 max-md:-mt-[48px] bg-white max-md:mt-20">
            <h2 className="py-[32px] text-[32px] md:text-[40px] font-extrabold text-center leading-[1.2] ">Anything Delivered</h2>
            <div className="flex max-md:flex-col max-md:items-center justify-center gap-[75px]">
              <div className="flex flex-col max-md:justify-center items-center">
                ...
                <button className="min-w-[308px] h-[40px] text-white text-[16px] font-bold bg-[#00A082FF] rounded-full md:hidden" onClick={openMapModal}>Explore stores around you</button>
              </div>
              <div className="flex flex-col max-md:justify-center items-center">
            ...
            <button className="min-w-[308px] md:w-[308px] h-[40px] max-md:hidden text-white text-[16px] font-bold bg-[#00A082FF] rounded-full" onClick={openMapModal}>Explore stores around you</button>
            </div>
          <div className="flex flex-col items-center justify-center bg-[#FFC244FF]  px-3 md:px-16 pt-[80px]  pb-[64px] mt-[24px] -mb-[195px] countries relative">
            <img src="/images/countries.svg" alt="" />
            <h1 className="font-bold text-[32px] md:text-[40px] my-[16px] text-center">Countries where we deliver</h1>
