const DoItTogether = () => {
    return ( 
        ...
        <div className="flex flex-col items-center justify-center gap-[48px]  -translate-y-28">
          ...
          <div className="flex max-md:flex-col items-center justify-center gap-[48px]">
            <div className="flex flex-col items-center justify-center mb-[50px]">
              <img src="/images/rider-image.png" alt="" className="w-72 md:w-64"/>
            ...
            <div className="flex flex-col items-center justify-center  mb-[50px]">
              <img src="/images/partners-image.png" alt="" className="w-72 md:w-64"/>
            ...
            <div className="flex flex-col items-center justify-center  mb-[50px]">
              <img src="/images/careers-image.png" alt="" className="w-72 md:w-64"/>
